...
import 'package:new_bmi/widgets/left_bar.dart';
import 'package:new_bmi/widgets/right_bar.dart';
            ...
            GestureDetector(
              onTap:(){
                ...
                setState(() {
                  ...
                  else if(_bmiResult >=18.5 && _bmiResult<= 25 ){_textResult = "You have normal weight"; }
                  else{
